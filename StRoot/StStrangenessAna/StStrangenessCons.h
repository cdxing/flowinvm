...
class Strangeness
{
  public:
    ...
    static TString Energy[5]; // 0 for 200GeV, 2 for 39GeV, 3 for 27GeV  // shaowei  1 for 54GeV
    ...
    static Float_t mBeamEnergy[5]; // 200GeV, 39GeV, 15GeV, 27GeV // shaowei
    static Int_t   mBeamYear[4]; 
    //--------------------------------------------------------------------
    // Histogram
    // pt bin
